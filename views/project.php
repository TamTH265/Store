...
<body>
  ...
  <div class="main-content container">
    <h3>
      <span class="category-title">Các dự án đã thực hiện</span>
    </h3>
    <div class="row">
    <?php 
      $conn = new mysqli($servername, $username, $password, $dbname);
      ...
      if ($result->num_rows > 0) {
        ...
        $productsTotal = (int)$row["COUNT(project_id)"];
      }
      ...
      $sql =  "SELECT img_link, project_name FROM Project LIMIT $startPage, $numOfProductsPerPage";
      $result = $conn->query($sql);
    ...
    ?>   
          <div class="col col-lg-4 col-sm-6 col-12 <?php echo $indexAtTwoColsState;?>-col <?php echo $indexAtThreeColsState; ?>-col">
            <div class="item">
              ...
              <span class="caption"><?php echo $row["project_name"]; ?></span>
            </div>
          </div>
    <?php 
        }
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination justify-content-center">
        ...
        ?>
        <li class="page-item">
          <a class="page-link" href="project.php?page=1" aria-label="Previous">
            <span aria-hidden="true"><i class="fas fa-angle-double-left"></i></span>
          </a>
        </li>
        <li class="page-item">
          <a class="page-link" href="project.php?page=<?php 
          if (!isset($_GET{'page'})) {
            echo $pagePrevOffset;
          } else {
            if($pagePrevOffset > 1) {
        ...
        ?>
            <li class="page-item">
              <a class="page-link" href="project.php?page=<?php echo $countPage; ?>"><?php echo $countPage; ?></a>
            </li>
        <?php } ?>
        ...
        <li class="page-item">
          <a class="page-link" href="project.php?page=<?php echo $pageTotal; ?>"  aria-label="Next">
