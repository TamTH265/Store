    ...
    <div class="row">
      ...
      <div class="row-down col-lg-3">
        ...
        <div class="panel panel-right-down">
          <div class="panel-heading-down">Sản phẩm nổi bật</div>
          <?php
            $db = new DBConnect();
            $conn = $db->connect();

            $sql = "SELECT id, title, imgAddress, category_id FROM products ORDER BY RAND() LIMIT 3";
            $result = $conn->query($sql);
          ...
          <div class="shock-news shock-news-bottom">
            <div class="media-img">
              <a href="product-detail.php?id=<?php echo $row["id"]; ?>&categoryId=<?php echo $row["category_id"]; ?>"><img src="<?php echo $row['imgAddress']; ?>" class="align-self-start mr-3" alt="..."></a>
            </div>
            <a href="product-detail.php?id=<?php echo $row["id"]; ?>&categoryId=<?php echo $row["category_id"]; ?>" class="shock-news-title"><?php echo $row['title']; ?></a>
          </div>
          <?php
              }
            }
